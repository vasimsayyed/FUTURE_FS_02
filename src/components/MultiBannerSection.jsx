      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          <BannerCard
            ...
            backgroundImage='/images/banner/b2.jpg'
          ...
          <BannerCard
            ...
            backgroundImage='/images/banner/b4.jpg'
